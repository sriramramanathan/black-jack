...
export function GameScreen({ gameState, myPlayerId, isHost, isConnected, error, send }) {
    ...
    // ── Render ───────────────────────────────────────────────────────────────
    return (_jsxs("div", { className: styles.layout, children: [showConfetti && _jsx(Confetti, {}), _jsxs("div", { className: styles.table, children: [_jsx(ErrorToast, { message: error }), resultToast && _jsx("div", { className: styles.resultToast, children: resultToast }), _jsxs("div", { className: styles.header, children: [_jsxs("span", { className: styles.roundLabel, children: ["Round ", gameState.roundNumber, isRoundOver ? ' (Completed)' : ''] }), _jsxs("div", { className: styles.phaseBlock, children: [_jsx("span", { className: styles.phaseSubLabel, children: "Round Status" }), _jsx("span", { className: styles.phaseLabel, children: phase.replace(/_/g, ' ') })] }), _jsx("span", { className: isConnected ? styles.dotOnline : styles.dotOffline })] }), _jsxs("div", { className: `${styles.dealerArea} ${isDealerBusy ? styles.dealerActive : ''}`, children: [_jsxs("p", { className: styles.seatLabel, children: ["Dealer", isDealerBusy && _jsx("span", { className: styles.dealerTurnLabel, children: " \u00B7 Dealer's Turn" })] }), dealer.hand.length === 0 ? (_jsx(PlaceholderHand, {})) : (_jsx(DealingHand, { cards: dealer.hand, dealtIndices: getDealtIndices(dealtCards, 'dealer') }))] }), otherPlayers.length > 0 && (_jsx("div", { className: styles.opponentsRow, children: otherPlayers.map(player => {
